    ...
    describe('email validator', function () {
        ...
        describe('with basic configuration', function () {
            withData({
                ...
                'angle brackets, name': ['Carsten Brandt <mails@cebe.cc>', false],
                'angle brackets, quoted name': ['"Carsten Brandt" <mails@cebe.cc>', false],
                'angle brackets, no name': ['<mails@cebe.cc>', false],
        ...
        describe('with allowed name', function () {
            withData({
                ...
                'unicode (russian characters) in domain': ['sam@рмкреатиф.ru', false],
                'ASCII in domain': ['example@xn--zcack7ayc9a.de', true],
                'angle brackets, name': ['Carsten Brandt <mails@cebe.cc>', true],
                'angle brackets, quoted name': ['"Carsten Brandt" <mails@cebe.cc>', true],
                'angle brackets, no name': ['<mails@cebe.cc>', true],
