 ...
 *
 * By default, [[send()]] will use the "mails" application component to send the current message.
 * The "mails" application component should be a mailer instance implementing [[MailerInterface]].
 *
 * @see BaseMailer
 *
...
abstract class BaseMessage extends BaseObject implements MessageInterface
{
     ...
     * the "mails" application component will be used instead.
